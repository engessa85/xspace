...
function CardR({ type, title, desc, langs, mainImage }) {
  return (
      ...
      <div className="p-14">
        <div className="flex sm:flex-row flex-col w-full sm:h-[250px]">
          <div className="sm:w-[60%] w-full flex flex-col items-start gap-6">
            ...
            <h1 className="sm:text-5xl text-3xl text-myback2">{title}</h1>
            <p className="sm:text-l text-sm text-myback2 max-w-[90%]">{desc}</p>
          ...
          <div className="sm:w-[40%] w-full hidden sm:flex items-center justify-end">
            <Image
              src={mainImage}
              width={350}
              height={350}
